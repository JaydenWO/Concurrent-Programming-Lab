...
public class ClientActivity extends AppCompatActivity {
    ...
    private WiFiDirectAdapter adapter1;
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mManager.connect(mChannel, config, new WifiP2pManager.ActionListener() {
                    ...
                    public void onSuccess() {
                        Toast.makeText(ClientActivity.this, "Connect success", Toast.LENGTH_SHORT).show();
    ...
    private void discoverService() {
        ...
        mManager.addServiceRequest(mChannel, serviceRequest,
                new WifiP2pManager.ActionListener() {
                    ...
                    @Override
                    public void onSuccess() {
                        Toast.makeText(ClientActivity.this, "Added service discovery request", Toast.LENGTH_SHORT).show();
                    }
        ...
        mManager.discoverServices(mChannel, new WifiP2pManager.ActionListener() {
            ...
            @Override
            public void onSuccess() {
                Toast.makeText(ClientActivity.this, "Service discovery initiated", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(int arg0) {
                Toast.makeText(ClientActivity.this, "Service discovery failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
